...
public class ViewElementUtil {
	...
	private Actions act;
	private ViewJavaScriptUtil jsutil;

	public ViewElementUtil(WebDriver driver) {
		this.driver = driver;
		act = new Actions(this.driver);
		jsutil=new ViewJavaScriptUtil(this.driver);
	}

	public WebElement getElement(By locator) {
		WebElement ele=driver.findElement(locator);
		if(Boolean.parseBoolean(ViewDriverFactory.highlight)) {
